...
- `IF-15` (`partial`): Deepen existing ethernet/pppoe/loopback/wireguard option parity. PPPoE DHCPv6-PD depth is now in place; remaining depth work targets ethernet/loopback/wireguard gaps.
