...
- `IF-15` (`partial`): Deepen existing ethernet/pppoe/loopback/wireguard option parity. PPPoE DHCPv6-PD and ethernet DHCP/DHCPv6/IPv6 option depth are now in place; remaining depth work targets loopback/wireguard gaps.
